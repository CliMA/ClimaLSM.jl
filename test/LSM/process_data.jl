...
using Dates
data = readdlm(
    "/Users/katherinedeck/Desktop/ozark_site/AMF_US-MOz_FLUXNET_SUBSET_2004-2019_3-5/AMF_US-MOz_FLUXNET_SUBSET_HH_2004-2019_3-5.csv",
    ',',
)

P_indices = [
    Array(1:1:73)[data[1, :] .== "P_F"][1],
    Array(1:1:73)[data[1, :] .== "P_F_QC"][1],
]
# mm/interval
LE_indices = [
    Array(1:1:73)[data[1, :] .== "LE_CORR"][1],
    Array(1:1:73)[data[1, :] .== "LE_F_MDS_QC"][1],
] # W/m^2

soil_water_indices = [
    Array(1:1:73)[data[1, :] .== "SWC_F_MDS_1"][1],
    Array(1:1:73)[data[1, :] .== "SWC_F_MDS_1_QC"][1],
] # %
soil_temp_indices = [
    Array(1:1:73)[data[1, :] .== "TS_F_MDS_1"][1],
    Array(1:1:73)[data[1, :] .== "TS_F_MDS_1_QC"][1],
] # deg C
...
writedlm(
    "/Users/katherinedeck/Desktop/ozark_site/p_data_2005.csv",
    otherwise_data,
    ',',
)
writedlm(
    "/Users/katherinedeck/Desktop/ozark_site/et_data_2005.csv",
    et_data,
    ',',
)
