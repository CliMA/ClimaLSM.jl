...
chosen_year = [year(d) for d in dates] .== 2017
...
writedlm("/Users/katherinedeck/Desktop/ozark_site/p_data_2017.csv", otherwise_data, ',')
writedlm("/Users/katherinedeck/Desktop/ozark_site/et_data_2017.csv", et_data, ',')
